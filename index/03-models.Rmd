...
$\epsilon_{\mu} \sim \mathcal{N}(0,\sigma_{\epsilon_{\mu}}^{2})$  
...
$WinProb_i = \frac{1}{n} \sum_{k=1}^nWinProb_{i*}$
$WinProb_i*$ is:  

  $CDF^{-1}(\frac{\mu_{i*} + s_{curr_{i*}}}{\sigma_{i*}})$ if $t_{i*} > 600$,  
  $GBM_{4th}(i*)$ if $0 <t_{i*} <= 600$, and   
  $GBM_{ot}(i*)$ if $t_{i*} < 0$  
