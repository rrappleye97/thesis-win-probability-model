...
mse.regular = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/mse-regular.Rda")
colnames(mse.regular)[1] = "Our Model"
kable(mse.regular, 
      caption = "Brier score by model",
      longtable = TRUE,
      booktabs = TRUE)

log.loss.regular = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/log-loss-regular.Rda")
colnames(log.loss.regular)[1] = "Our Model"
...
mse.quarter.df = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/mse-quarter-df.Rda")
...
mse.quarter.plot = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/mse-quarter-plot.Rda")
mse.quarter.plot
```
...
mse.down.df = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/mse-down-df.Rda")
...
test.set = readRDS(file = "/home/guest/thesis-sp19-rappleye-nfl_calculator/predictions-2017.Rda")
