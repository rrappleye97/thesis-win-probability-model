...
my.calibration.plot = ggplot() +
  ...
  labs(title = "Actual vs. Predicted Win Probability for Our Model", x = "Predicted Win Probability", y = "Actual Win Probability", size = "Size")
lock.calibration.plot = ggplot() +
  ...
  labs(title = "Actual vs. Predicted Win Probability for Lock and Nettleton's Model", x = "Predicted Win Probability", y = "Actual Win Probability", size = "Size")
scrapr.calibration.plot = ggplot() +
  ...
  labs(title = "Actual vs. Predicted Win Probability for the nflscrapR model", x = "Predicted Win Probability", y = "Actual Win Probability", size = "Size")
